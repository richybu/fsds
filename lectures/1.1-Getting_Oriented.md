...
The [Knuth reward check](https://en.m.wikipedia.org/wiki/Knuth_reward_check) ('cheque') is "among computerdom's most prized trophies" [^1] but was almost never cashed! They were rewards for finding 'bugs' of any sort in Knuth's seminal books on programming.
...
Report a bug (or make a helpful suggestion) of any sort on GitHub using the [issues](https://github.com/jreades/fsds/issues) tracker then it will count towards your contribution to the module. 
